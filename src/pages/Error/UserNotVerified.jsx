...
const UserNotVerified = () => {
  ...
  return (
    <div>
      <div className="h-screen w-screen bg-red-500 dark:bg-gray-900 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8 text-center">
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              Check your email for verification & log in again
            </p>
          </div>
          <div className="mt-8">
            <div
